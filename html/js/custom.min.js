  ...
  $(function () {
    ...
    $(".right-side-toggle").click(function () {
      $(".right-sidebar").slideDown(50),
        ...
        $("body").hasClass("fix-header")
          ? $(".fxhdr").attr("checked", !0)
          : $(".fxhdr").attr("checked", !1),
        $("body").hasClass("fix-sidebar")
          ? $(".fxsdr").attr("checked", !0)
          : $(".fxsdr").attr("checked", !1);
    }),
    $(function () {
        ...
        (topOffset = 60),
          (width =
            this.window.innerWidth > 0
              ...
              : this.screen.width),
          width < 768
            ? ($("div.navbar-collapse").addClass("collapse"), (topOffset = 100))
